                ...
                long hitfinderLocalBGRadius, char* outliersMask)
{
	...
	peaklist->peak_maxintensity = (float *)malloc(sizeof(float) * peaks_to_add);
	peaklist->peak_totalintensity = (float *)malloc(sizeof(float) * peaks_to_add);
	peaklist->peak_sigma = (float *)malloc(sizeof(float) * peaks_to_add);
	peaklist->peak_snr = (float *)malloc(sizeof(float) * peaks_to_add);
	peaklist->peak_npix = (float *)malloc(sizeof(float) * peaks_to_add);
	peaklist->peak_com_x = (float *)malloc(sizeof(float) * peaks_to_add);
	peaklist->peak_com_y = (float *)malloc(sizeof(float) * peaks_to_add);
	peaklist->peak_com_index = (long *)malloc(sizeof(long) * peaks_to_add);
